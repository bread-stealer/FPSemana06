# Adicione o script pagamento.py ao repositório.
# Implemente uma class base denominada Pagamento com método processar_pagamento, e três classes:
#   CartaoCredito,
#   PayPal
#   TransferenciaBancaria
# Que herdam da classe Pagamento e implementam o método processar_pagamento.
# Crie uma função realizar_pagamento que aceite um objeto do tipo Pagamento e chame o método processar_pagamento.
...
#   Output:
#   €150.00 com Cartão de Crédito (1234 5678 9012 3456)
#   €200.00 com PayPal (e-mail: joao.silva@email.com)
#   €300.00 com Transferência Bancária (banco: Banco Central, conta: 12345678
